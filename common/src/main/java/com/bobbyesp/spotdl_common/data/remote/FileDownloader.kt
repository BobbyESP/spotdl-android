...
import com.bobbyesp.spotdl_common.utils.exceptions.FileDownloadException
    ...
    suspend fun downloadFileWithProgress(
        ...
        try {
            client.prepareGet(fileUrl).execute { response ->
                ...
                if(BuildConfig.DEBUG) Log.i("File Downloader","Downloaded file from $fileUrl || Content length: $contentLength")
            }
